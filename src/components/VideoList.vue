    ...
    <van-row class="player-songs__row">
      <van-col span="24" class="player-songs__row-col">
        <ul class="player-songs__row-col__ul">
          <li class="player-songs__row-col__ul-li">
            <div class="thumb">
              <img class="thumb-img" src="https://i.ytimg.com/vi/d0R-JyU4Btk/hq720.jpg" alt="" />
              <span class="thumb-time">1:24:14</span>
            ...
            <div class="player-songs__row-col__title">80分鐘串燒系列 - 2024不能不聽的100首歌</div>
          </li>
          <li class="player-songs__row-col__ul-li">
            <div class="thumb">
              <img class="thumb-img" src="https://i.ytimg.com/vi/d0R-JyU4Btk/hq720.jpg" alt="" />
...
<script setup lang="ts" name="VideoList"></script>
